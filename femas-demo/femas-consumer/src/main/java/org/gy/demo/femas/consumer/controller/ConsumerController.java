...
package org.gy.demo.femas.consumer.controller;
...
import org.gy.demo.femas.consumer.proxy.ProviderService;
...
public class ConsumerController {
    ...
    public Object services() {
        return discoveryClient.getInstances("femas-provider");
    }

    @RequestMapping("/discover")
    public Object discover() {
        return loadBalancer.choose("femas-provider").getUri().toString();
    }
    ...
    public String restEchoProvider(@PathVariable String str,
        ...
        return restTemplate.getForObject("http://femas-provider/echo/" + str, String.class);
    }
    ...
    public String restEchoErrorProvider(@PathVariable String str,
        ...
        return restTemplate.getForObject("http://femas-provider/echo/error/" + str, String.class);
    }
